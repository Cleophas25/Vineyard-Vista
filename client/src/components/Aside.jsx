  ...
  return (
    <aside className='w-full md:w-1/3 flex flex-col items-center px-3 sticky top-5 md:max-h-screen pt-12 pb-4 -mt-12 mb-20'>
      <div className='w-full bg-white shadow flex flex-col my-4 p-6'>
        ...
        <p className='pb-2'>
          Fueled by a family's generational passion for viticulture, our winery
          was founded with a vision to share the exceptional wines cultivated
          from our cherished land. This dream has blossomed into a legacy of
